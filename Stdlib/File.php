...
class File {
	...
	final public static function setExtensions($property, array $extensions) {
		self::$_extensions[$property] = $extensions;
	...
	final public static function addBadExtension($property, $ext) {
		self::$_badExtensions[$property][] = $ext;
	...
	final public static function setBadExtensions($property, array $extensions) {
		self::$_badExtensions[$property] = $extensions;
	...
	final public static function getMaxSize() {
		if (self::$_maxSize === null) {
			self::$_maxSize = ini_get('upload_max_filesize');
		}

		return self::parseSize(self::$_maxSize);
	}
	...
	final public static function extensionIsOk($property, $extension) {
		if (isset(self::$_extensions[$property]) && !in_array($extension, self::$_extensions[$property]))
			return false;
		if (isset(self::$_badExtensions[$property]) && in_array($extension, self::$_badExtensions[$property]))
			return false;
